...
const SidebarProvider = React.forwardRef(
  (
    ...
    const [isHeaderMoved, setIsHeaderMoved] = React.useState(!defaultOpen);

    const toggleHeader = React.useCallback(() => {
      setIsHeaderMoved((prev) => !prev);
    }, []);
    ...
    const contextValue = React.useMemo(
      () => ({
        ...
        setOpenMobile,
        toggleSidebar,
        toggleHeader, // Add toggleHeader to context value
        isHeaderMoved,
      }),
      [
        state,
...
const SidebarTrigger = React.forwardRef(
  ({ className, onClick, ...props }, ref) => {
    const { toggleSidebar, toggleHeader } = useSidebar(); // Destructure toggleHeader from context
